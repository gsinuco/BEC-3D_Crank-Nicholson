...
MODULE geometrical_constants
  ...
  DOUBLE PRECISION, PARAMETER:: BOX_SIZE_X = 200E-6
  DOUBLE PRECISION, PARAMETER:: BOX_SIZE_Y = 200E-6
  DOUBLE PRECISION, PARAMETER:: BOX_SIZE_Z = 400E-6
...
SUBROUTINE INITIAL_STATE(x,delta,w,BOX_SIZE,N)
  ...
  open(2,file="ShellLargeStrong_128x128x128.dat",action="read")
...
SUBROUTINE WRITE_FUN(x_aux,delta,BOX_SIZE)
  ...
  open(2,file="gs1D_Shell_LS.dat",access='append')
  open(3,file="gs3D_Shell_LS.dat",access='append')
