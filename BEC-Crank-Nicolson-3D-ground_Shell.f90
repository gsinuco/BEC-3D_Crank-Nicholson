...
MODULE geometrical_constants
  INTEGER, PARAMETER :: iterations = 512
...
MODULE physical_constants
  ...
  DOUBLE PRECISION, PARAMETER:: deltat  = 0.5E-4
...
SUBROUTINE INITIAL_STATE(x,delta,w,BOX_SIZE,N)
  ...
  open(2,file="ShellSmallStrong_128x128x128.dat",action="read")
...
SUBROUTINE WRITE_FUN(x_aux,delta,BOX_SIZE)
  ...
  open(2,file="gs1D_Shell.dat",access='append')
  open(3,file="gs3D_Shell.dat",access='append')
