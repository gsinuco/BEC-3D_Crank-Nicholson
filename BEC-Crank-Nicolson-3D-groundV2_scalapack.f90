...
MODULE geometrical_constants
  INTEGER, PARAMETER :: iterations = 4000
  INTEGER, PARAMETER :: frames     = 1
  INTEGER, PARAMETER :: D          = 3
  INTEGER, PARAMETER :: N_x        = 2000
  INTEGER, PARAMETER :: N_y        = 50
  INTEGER, PARAMETER :: N_z        = 50
  INTEGER, PARAMETER :: NN         = 5000000

  DOUBLE PRECISION, PARAMETER:: BOX_SIZE_X = 400.0E-6
  DOUBLE PRECISION, PARAMETER:: BOX_SIZE_Y = 1.0E-6
  DOUBLE PRECISION, PARAMETER:: BOX_SIZE_Z = 1.0E-6
...
MODULE atomic_properties
  ...
  DOUBLE PRECISION, PARAMETER :: N_0  = 2000.0
  DOUBLE PRECISION            :: U_0  = 4.0*pi*hbar*hbar*a*N_0/mass
END MODULE atomic_properties

MODULE potential_constants
  USE physical_constants
  DOUBLE PRECISION, PARAMETER :: w_x  = 2.0*pi*6.0
  DOUBLE PRECISION, PARAMETER :: w_y  = 2.0*pi*410.0
  DOUBLE PRECISION, PARAMETER :: w_z  = 2.0*pi*410.0  
...
SUBROUTINE WRITE_FUN(x_aux,delta,BOX_SIZE)
  ...
  open(2,file="gs1D_test_2_serieV2.dat")
  open(3,file="gs3D_test_2.dat")
